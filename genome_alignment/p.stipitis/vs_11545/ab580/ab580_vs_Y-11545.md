...
```bash
OutDir=analysis/genome_alignment/circos/vs_Y-11545_v2_circos/ab580
mkdir -p $OutDir
```
```bash
QueryGenome=$(ls niab_assemblies/pichia/580/*.fasta)
...
```bash
OutDir=analysis/genome_alignment/circos/vs_Y-11545_v2_circos/ab580
Coords=$(ls analysis/genome_alignment/mummer/pichia/580/*/*_coords.tsv)
...
cat $OutDir/query_ref_genome.txt | grep -w -v -f tmp.txt | cut -f3 -d ' '| tr -d '\n' | sed 's/ab580/, ab580/g' | sed 's/Y-11545_v2/, Y-11545_v2/g'
```
```
580_bctg00000007580_bctg00000004580_bctg00000005, Y-11545_v2_chr_8.1, Y-11545_v2_chr_7.1, Y-11545_v2_chr_6.1, Y-11545_v2_chr_5.1, Y-11545_v2_chr_4.1, Y-11545_v2_chr_3.1, Y-11545_v2_chr_2.1, Y-11545_v2_chr_1.2, Y-11545_v2_chr_1.1
```
To generate the plot from NIAB cluster:

```bash
OutDir=/home/vegasa/circos/vs_Y-11545_v2_circos/ab580
