...
```bash
OutDir=analysis/genome_alignment/circos/vs_AS22/ab1097
mkdir -p $OutDir
```
```bash
QueryGenome=$(ls niab_assemblies/c.albicans/ab1097/*.fasta)
ProgDir=~/git_repos/tools/seq_tools/circos
python $ProgDir/fasta2circos.py --genome $QueryGenome --contig_prefix "1097_" > $OutDir/query_genome.txt
...
```bash
OutDir=analysis/genome_alignment/circos/vs_AS22/ab1097
Coords=$(ls analysis/genome_alignment/mummer/c.albicans/ab1097/*/*_coords.tsv)
ProgDir=git_repos/scripts/alternaria/pathogen/genome_alignment
$ProgDir/nucmer_coords2circos.py --inp_coords $Coords --queery_id 1097 --ref_id A22 > $OutDir/query_vs_ref_links.txt
...
echo "Order of unseen A22 contigs and remaining ab1097 contigs"
cat $OutDir/query_ref_genome.txt | grep -w -v -f tmp.txt | cut -f3 -d ' '| tr -d '\n' | sed 's/ab1097/, ab1097/g' | sed 's/A22/, A22/g'
```

```
1097_bctg00000011, A22_Ca22chrRA_C_albicans_SC5314, A22_Ca22chrM_C_albicans_SC5314, A22_Ca22chr7A_C_albicans_SC5314, A22_Ca22chr6A_C_albicans_SC5314, A22_Ca22chr5A_C_albicans_SC5314, A22_Ca22chr4A_C_albicans_SC5314, A22_Ca22chr3A_C_albicans_SC5314, A22_Ca22chr2A_C_albicans_SC5314, A22_Ca22chr1A_C_albicans_SC5314
```

Running in circos:

```bash
OutDir=/home/vegasa/circos/vs_AS22/ab1097
ProgDir=~/git_repos/scripts/circos_plots/genome_alignment/C.albicans/TLO_project/vs_A22/ab1097
circos -conf $ProgDir/A22_vs_ab1097_circos.conf -outputdir $OutDir
mv $OutDir/circos.png $OutDir/ab1097_vs_A22_circos.png
mv $OutDir/circos.svg $OutDir/ab1097_vs_A22_circos.svg
ls $PWD/$OutDir/ab1097_vs_A22_circos.pngg
```
